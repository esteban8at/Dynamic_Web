<?php
	...
	//Capturo parametros procedentes de ejemplo9.html
	$lat_g = $_POST['lat_g'];
	$lat_m = $_POST['lat_m'];
	$lat_s = $_POST['lat_s'];
	...
	SELECT st_x( st_transform(  st_setsrid( st_makepoint(-76.541497222222,3.4201666666667),4326 )   , 3115 ) ) as coordenada_x_3115,
       st_y( st_transform(  st_setsrid( st_makepoint(-76.541497222222,3.4201666666667),4326 )   , 3115 ) ) as coordenada_y_3115,
       st_x( st_transform(  st_setsrid( st_makepoint(-76.541497222222,3.4201666666667),4326 )   , 21896 ) ) as coordenada_x_21896,
       st_y( st_transform(  st_setsrid( st_makepoint(-76.541497222222,3.4201666666667),4326 )   , 21896 ) ) as coordenada_y_21896
